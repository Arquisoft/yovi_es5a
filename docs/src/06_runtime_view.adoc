...
Flujo:
1. Cliente prepara un JSON en notación YEN describiendo la posición en un parámetro position y hace GEt la API de nuestro servidor
2. Se envía la notación YEN a GameY; si es válido se invoca al bot para que calcule el proximo movimiento.
3. Respuesta: En formato YEN en JSON. Contiene el estado del tablero tras realizar el movimiento.
