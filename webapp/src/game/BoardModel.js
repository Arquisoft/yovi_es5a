export default class BoardModel {
  ...
  getCurrentPlayer() { return this.turnNumber % 2 === 1 ? "player1" : "player2"; }
  getCurrentTurn() { return this.getCurrentPlayer(); }
  nextTurn() { this.turnNumber += 1; }

  setCellOwner(cellId, player) {
    const cell = this.cells.find((c) => c.id === cellId);
    if (cell) cell.state = player;
  }
}
