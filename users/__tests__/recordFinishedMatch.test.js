...
describe('recordFinishedMatch', () => {
  ...
  // Tu código espera un objeto con .id
  gameRepo.findUserIdByUsername.mockResolvedValueOnce({ id: 11 })
  ...
  expect(gameRepo.insertUserGame).toHaveBeenCalledWith(
    101,
    11,
    null,
    'Luis',
  ...
  expect(gameRepo.updateUserBotStats).toHaveBeenCalledWith(
    11,
    250,
    conn
  )
  ...
  gameRepo.findUserIdByUsername.mockResolvedValueOnce({ id: 77 })
  ...
  expect(gameRepo.insertUserBotGame).toHaveBeenCalledWith(
    101,
    77,
    5,
    'medio',
