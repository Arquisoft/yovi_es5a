...
The deployment url is: [https://arquisoft.github.io/yovi_es5a/](https://arquisoft.github.io/yovi_es5a/).
...
If we want to deploy it to GitHub pages, so it is accessible via [https://arquisoft.github.io/yovi_es5a/](https://arquisoft.github.io/yovi_es5a/), we need to execute `npm run deploy`.
