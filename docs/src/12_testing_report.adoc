...
Los tests end-to-end verifican que los flujos principales funcionan correctamente desde el navegador con la aplicación completa levantada.
...
El archivo `webapp/test/e2e/features/users.feature` existe en el repositorio pero está comentado, por lo que no forma parte de la suite activa.
